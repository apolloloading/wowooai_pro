...
// Doc EN URLs per channel (anchors on https://wowooai.agentscope.io/docs/channels)
const CHANNEL_DOC_EN_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk:
    "https://wowooai.agentscope.io/docs/channels/?lang=en#DingTalk-recommended",
  feishu: "https://wowooai.agentscope.io/docs/channels/?lang=en#Feishu-Lark",
  imessage:
    "https://wowooai.agentscope.io/docs/channels/?lang=en#iMessage-macOS-only",
  discord: "https://wowooai.agentscope.io/docs/channels/?lang=en#Discord",
  qq: "https://wowooai.agentscope.io/docs/channels/?lang=en#QQ",
  telegram: "https://wowooai.agentscope.io/docs/channels/?lang=en#Telegram",
  mqtt: "https://wowooai.agentscope.io/docs/channels/?lang=en#MQTT",
  mattermost: "https://wowooai.agentscope.io/docs/channels/?lang=en#Mattermost",
  matrix: "https://wowooai.agentscope.io/docs/channels/?lang=en#Matrix",
  sip: "https://wowooai.agentscope.io/docs/channels/?lang=en#SIP",
  wecom:
    "https://wowooai.agentscope.io/docs/channels/?lang=en#WeCom-WeChat-Work",
  weixin:
    "https://wowooai.agentscope.io/docs/channels/?lang=en#WeChat-Personal-iLink",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
  onebot:
    "https://wowooai.agentscope.io/docs/channels/?lang=en#OneBot-v11-NapCat--QQ-full-protocol",
};

// Doc ZH URLs per channel (anchors on https://wowooai.agentscope.io/docs/channels)
const CHANNEL_DOC_ZH_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk: "https://wowooai.agentscope.io/docs/channels/?lang=zh#钉钉推荐",
  feishu: "https://wowooai.agentscope.io/docs/channels/?lang=zh#飞书",
  imessage:
    "https://wowooai.agentscope.io/docs/channels/?lang=zh#iMessage仅-macOS",
  discord: "https://wowooai.agentscope.io/docs/channels/?lang=zh#Discord",
  qq: "https://wowooai.agentscope.io/docs/channels/?lang=zh#QQ",
  telegram: "https://wowooai.agentscope.io/docs/channels/?lang=zh#Telegram",
  mqtt: "https://wowooai.agentscope.io/docs/channels/?lang=zh#MQTT",
  mattermost: "https://wowooai.agentscope.io/docs/channels/?lang=zh#Mattermost",
  matrix: "https://wowooai.agentscope.io/docs/channels/?lang=zh#Matrix",
  sip: "https://wowooai.agentscope.io/docs/channels/?lang=zh#SIP",
  wecom: "https://wowooai.agentscope.io/docs/channels/?lang=zh#企业微信",
  weixin: "https://wowooai.agentscope.io/docs/channels/?lang=zh#微信个人iLink",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
  onebot:
    "https://wowooai.agentscope.io/docs/channels/?lang=zh#OneBot-v11NapCat--QQ-完整协议",
};
      ...
      case "weixin":
        return (
          <>
            ...
            >
              <Input placeholder="~/.wowooai/weixin_bot_token" />
            </Form.Item>
            <Form.Item name="media_dir" label={t("channels.weixinMediaDir")}>
              <Input placeholder={defaultMediaDir} />
            </Form.Item>
          ...
          <Button
            ...
            onClick={() => {
              const url =
                CHANNEL_DOC_EN_URLS[activeKey]! ||
                CHANNEL_DOC_ZH_URLS[activeKey]!;
              const isWowooAIDoc = url.includes(
                "wowooai.agentscope.io/docs/channels/",
              );
              const finalUrl =
                isWowooAIDoc && currentLang === "zh"
                  ? CHANNEL_DOC_ZH_URLS[activeKey]!
                  : CHANNEL_DOC_EN_URLS[activeKey]!;

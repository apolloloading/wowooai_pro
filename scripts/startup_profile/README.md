...
One-click analysis of wowooai startup performance, identify bottlenecks, and provide optimization suggestions.
...
- **Import Time Analysis** - wowooai modules and third-party library import time ranking
...
2. **Data Analysis**
   - Parse log files
   - Categorize statistics (wowooai/third-party/stdlib)
...
- Python 3.8+
- No extra dependencies (except wowooai itself)
- Pure JSON data output
- HTML runs standalone, viewable offline

## Related Tools

- `src/wowooai/utils/startup_display.py` - Startup banner display

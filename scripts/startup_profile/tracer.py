#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Function execution tracer for wowooai."""
import json
import time
import traceback
...
class ExecTracer:
    """Trace function execution in wowooai package."""
...
def main():
    """Run tracer on wowooai app import."""
    ...
    tracer = ExecTracer(package_names=["wowooai"])
    sys.settrace(tracer.trace_calls)

    try:
        # Import wowooai app to trigger startup
        from wowooai.app._app import (  # pylint: disable=unused-import
            app,
        )  # noqa: F401
    finally:
        sys.settrace(None)

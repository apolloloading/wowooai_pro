# -*- coding: utf-8 -*-
"""Tool-guard mixin for wowooaiAgent.
...
if TYPE_CHECKING:
    from wowooai.app.approvals.models import PendingApproval
    from wowooai.security.tool_guard.approval import ApprovalDecision
...
class ToolGuardMixin:
    ...
    def _init_tool_guard(self) -> None:
        ...
        from wowooai.security.tool_guard.engine import get_guard_engine
        from wowooai.app.approvals import get_approval_service
    ...
    async def _decide_guard_action(
        ...
        from wowooai.security.tool_guard.utils import log_findings
    ...
    async def _acting_auto_denied(
        ...
        from wowooai.security.tool_guard.approval import (

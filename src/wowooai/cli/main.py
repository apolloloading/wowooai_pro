...
@click.group(
    ...
    lazy_subcommands={
        "acp": ("wowooai.cli.acp_cmd", "acp_cmd", ".acp_cmd"),
        "app": ("wowooai.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "wowooai.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("wowooai.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("wowooai.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("wowooai.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("wowooai.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("wowooai.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("wowooai.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("wowooai.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "wowooai.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("wowooai.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "wowooai.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("wowooai.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("wowooai.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "wowooai.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("wowooai.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("wowooai.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("wowooai.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": (
            "wowooai.cli.plugin_commands",
            "plugin",
            ".plugin_commands",
        ),
        "task": ("wowooai.cli.task_cmd", "task_cmd", ".task_cmd"),
        "doctor": ("wowooai.cli.doctor_cmd", "doctor_cmd", ".doctor_cmd"),
    },
)
@click.version_option(version=__version__, prog_name="wowooai")

...
class LlamaCppBackend:
    """
    wowooai local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"wowooai-llamacpp-download-{staging_dir.name}",
            command=["wowooai-llamacpp-download", download_url],

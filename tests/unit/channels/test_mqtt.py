...
def mqtt_channel(mock_process):
    ...
    from wowooai.app.channels.mqtt.channel import MQTTChannel
    ...
    channel = MQTTChannel(
        ...
        username="test_user",
        password="test_pass",
        subscribe_topic="wowooai/in/{client_id}",
        publish_topic="wowooai/out/{client_id}",
        bot_prefix="[BOT] ",
        clean_session=True,
        qos=2,
        tls_enabled=False,
...
class TestMQTTChannelLifecycle:
    ...
    async def test_start_success(self, mqtt_channel, mock_mqtt_client):
        ...
        with patch(
            "wowooai.app.channels.mqtt.channel.mqtt.Client",
...
class TestMQTTChannelMessageHandling:
    ...
    def test_on_message_json_payload_with_explicit_client_id(
        ...
        mock_msg = MagicMock()
        mock_msg.topic = "wowooai/in/ignored-topic-client"
    ...
    def test_on_message_plaintext_payload(self, mqtt_channel):
        ...
        mock_msg = MagicMock()
        mock_msg.topic = "wowooai/in/test-client"
    ...
    def test_on_message_extracts_client_id_from_topic(self, mqtt_channel):
        ...
        mock_msg = MagicMock()
        mock_msg.topic = "wowooai/in/my-device-001"
        ...
        call_args = mock_enqueue.call_args[0][0]
        # Topic "wowooai/in/my-device-001"
        # parts[1] = "in"
...
class TestMQTTChannelSend:
    ...
    async def test_send_media_audio(self, mqtt_channel, mock_mqtt_client):
        ...
        from wowooai.app.channels.base import AudioContent, ContentType

...
import wowooai.providers.provider_manager as provider_manager_module
from wowooai.exceptions import ProviderError
from wowooai.providers.anthropic_provider import AnthropicProvider
from wowooai.config.config import ModelSlotConfig
from wowooai.providers.openai_provider import OpenAIProvider
from wowooai.providers.provider import ModelInfo
from wowooai.providers.provider_manager import ProviderManager
from wowooai.local_models.llamacpp import LlamaCppServerSetupResult
...
def isolated_secret_dir(monkeypatch, tmp_path):
    secret_dir = tmp_path / ".wowooai.secret"
...
async def test_resume_local_model_restores_server_and_runtime_state(
    ...
    manager = ProviderManager()
    model_id = "AgentScope/wowooai-Flash-2B-Q4_K_M"
    ...
    provider = manager.get_provider("wowooai-local")

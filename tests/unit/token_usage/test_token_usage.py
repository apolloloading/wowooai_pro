...
from wowooai.token_usage.buffer import (
    TokenUsageBuffer,
    _UsageEvent,
    _apply_event,
)
from wowooai.token_usage.manager import (
    TokenUsageByModel,
    TokenUsageManager,
    TokenUsageRecord,
    TokenUsageStats,
...
from wowooai.token_usage.model_wrapper import TokenRecordingModelWrapper
from wowooai.token_usage.storage import load_data, save_data_sync
...
class TestTokenUsageManagerCore:
    ...
    def test_get_instance_returns_singleton(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "wowooai.token_usage.manager.WORKING_DIR",
            tmp_path,
        )
        monkeypatch.setattr(
            "wowooai.token_usage.manager.TOKEN_USAGE_FILE",

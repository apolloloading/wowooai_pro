...
from wowooai.utils.logging import (
    ColorFormatter,
...
class TestAddFileHandler:
    ...
    def test_creates_log_directory(self, tmp_path):
        ...
        log_path = tmp_path / "logs" / "wowooai.log"
...
class TestLogConstants:
    ...
    def test_log_namespace_is_wowooai(self):
        """S级: LOG_NAMESPACE is 'wowooai'."""
        assert LOG_NAMESPACE == "wowooai"
